  ...
  return (
    <div className="min-h-screen text-slate-900">
      ...
      <div className="pt-[4.5rem] md:pl-[17rem] md:pt-4">
        <header className="sticky top-2 z-10 px-4 md:top-4 md:pr-4 animate-fade-in-down">
          <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-3 rounded-card border border-slate-200/70 bg-white/75 px-5 py-3.5 shadow-float backdrop-blur-xl">
